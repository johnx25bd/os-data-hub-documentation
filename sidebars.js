module.exports = {
  docs: [
    {
      "type": "doc",
      "id": "os-data-hub/welcome"
    },
    { "type": "category", "label": "OS Data Hub", "items": ["os-data-hub/quickstart", "os-data-hub/overview", "os-data-hub/faq"] },
    { "type": "category", "label": "OS Maps API", "items": ["os-maps-api/quickstart", "os-maps-api/overview", "os-maps-api/technical-specification"] },
    { "type": "category", "label": "OS Vector Tile API", "items": ["os-vector-tile-api/quickstart", "os-vector-tile-api/overview", "os-vector-tile-api/technical-specification"] },
